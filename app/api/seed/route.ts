...
const initialFunds = [
    ...
    { name: 'Altos Ventures', website: 'https://www.altosvc.com', stage: 'early' },
    ...
    { name: 'Foothill Ventures', website: 'https://foothillventures.com', stage: 'early' },
    ...
    { name: 'Primary Venture Partners', website: 'https://www.primaryventurepartners.com', stage: 'early' },
...
export async function GET() {
  try {
    ...
    const existingFunds = await sql`SELECT COUNT(*) FROM funds`;
    
    if (existingFunds.rows[0].count > 0) {
      return NextResponse.json({ 
        message: 'Database already seeded',
        count: existingFunds.rows[0].count 
      }, { status: 200 });
    }
